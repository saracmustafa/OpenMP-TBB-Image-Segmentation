...
void imageSegmentation(int *labels, unsigned char *data, int width, int height, int pixelWidth, int numThreads, int Threshold)
{
...
int main(int argc,char **argv)
{
	...
	imageSegmentation(labels,data,width,height,pixelWidth,numThreads,Threshold);
